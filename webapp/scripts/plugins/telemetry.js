...
define(['./telemetry-metadata',
        './historical-telemetry-provider',
        './realtime-telemetry-provider'],
    function (TelemetryMetadata, HistoricalTelemetryProvider, RealtimeTelemetryProvider) {
        'use strict';
        ...
        var objectProvider = {
            get: function (identifier) {
                ...
                var measurement = TelemetryMetadata().telemetry.find(function (m) {
        ...
        var compositionProvider = {
            ...
            load: function (domainObject) {
                ...
                var measurements = TelemetryMetadata().telemetry;
